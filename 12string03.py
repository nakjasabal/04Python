'''
format() 함수 
: 문자열 포매팅(String formatting)은 서식문자보다 더 간단히
문자열을 표현할 수 있다. 중괄호 안에 포매팅을 지정하고 format()
함수로 값을 삽입한다. 
형식] '{인덱스}' . format(값 or 변수)
'''
# 값 직접 대입하기 
